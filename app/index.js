        ...
        return (
            <Router>
                <Scene key="root">
                    ...
                    <Scene key="inbox" component={Inbox} title="Inbox" titleStyle={{alignSelf: 'center'}} onLeft={() => Actions.home()} leftTitle='< Home' onRight={() => Actions.create_message()} rightTitle='Message' />
                </Scene>
            </Router>
        );
    }
